...
# This file is a template. During skill generation, audit-chinese-labor-evidence-chain-skill is replaced
...
# Constants
# ---------------------------------------------------------------------------
SKILL_NAME="audit-chinese-labor-evidence-chain-skill"
VERSION="1.0.0"
...
resolve_install_path() {
    ...
    if [ -n "$CUSTOM_PATH" ]; then
        case "${CUSTOM_PATH%/}" in
            */.codex/skills|*/.agents/skills|*/.claude/skills|*/.copilot/skills)
                INSTALL_DIR="${CUSTOM_PATH%/}/${SKILL_NAME}"
                ;;
            *)
...
install_files() {
    ...
    # Copy the complete distributable package, including this installer.
    file_count=0
